...
**适合动手的人**：已经在拍胶片，手里有一台能架起来的相机；想要在[基准 ISO](glossary.zh-CN.md#基准-iso)、f/8 下拍摄，并且完全不用担心震动；不介意打印九个件、压几颗磁铁——没有任何要拧、要焊、要粘的东西。
...
- [ ] 你能不能打印、或者找到人打印占地 124.8 × 154.8 mm 的件——够得到一张 160 × 160 mm 的打印床吗？
...
判断一只闪光灯合不合用，只看一点：**能不能手动调出力**。它的尺寸无所谓，灯头也不需要能转——它只是平躺在箱口而已。[TTL](glossary.zh-CN.md#ttl) 和[高速同步（HSS）](glossary.zh-CN.md#hss)在这里毫无用处——别为它们花钱。

## 费用与时间

价格集中写在一个地方——[物料清单](bom.zh-CN.md#工具与耗材)。这一页只把开销分好堆：
...
| 可选升级——防牛顿环玻璃、LED 定位灯带、植绒贴 | 在物料清单中计价 |
...
| 乳白亚克力定制切割 | 数日 | 定制裁 68 × 118 × 2 mm；v4 时期的 110 × 130 mm 板可以让店家裁小续用 |
...
**平行度。** 胶片平面必须与传感器平行，而不只是水平——而且这套设计里，箱子上没有任何可调的东西。把一小块平面镜放在放胶片的位置，挪动相机，直到镜头自己的倒影正好落在画面正中。倒影一居中，传感器就与片平面平行了，下面所有打印件的公差也在同一步里被吸收掉。先平行度，后均匀性。
...
由此还有几条好处。每一格得到的输出完全一致，一卷片子共用一条反相曲线；基准 ISO、f/8 就是这套设计的工作点；氙气灯管给出的是真正连续的日光平衡光谱。

物料清单里那条可选的 LED 灯带不改变这套论证：它贴在腔内侧壁上，是一盏定位常亮灯——取景和过片时照个亮——与曝光无关。

</details>

## 常见问题

**有人真做出来过吗？** 没有。v5 的几何在 CAD 里逐项核对过尺寸，导出的文件也做过数值校验，但从来没有一只实体箱子被打印、拍摄、实测或做过均匀性测试。所有关于光学的说法都请当成推演结果，而不是实测结果。
...
> [!CAUTION]
> 玻璃模式下，玻璃底面离焦平面只有 0.2 mm，落在那里的灰尘会直接进画面。元件装进去一次就不再动——装之前先用气吹吹干净。相比之下，乳白亚克力上的灰尘永远不会成像：它就落在发光面本身上，偶尔擦一擦就够了。
...
**怎么过片、怎么换画幅？** 过片靠抽：捏住伸出夹外的片头直接拉——胶片滑过压平元件下方时，拱起的部位会被顺势压平，一卷拍完之前夹子不用打开。换画幅就是掀掉一副夹子、放上另一副，磁吸自动定位，5 秒钟的事。拍 6×6 时把遮幅插片垫在 120 底座下面——夹子整体抬高 1 mm，属正常现象；6×4.5 没有专用遮幅，后期裁切。长片条的尾巴会搭在托盘凸缘上，比片平面略低——远端用手托一下。装片和取放写在[翻拍](scanning.zh-CN.md#装片)里。
