...
- **垫片沉孔**：四个，10.6 见方、深 1.0，位于 (±41, ±12)。每孔放入一片 10 × 10 × 1 钢垫片（或 Ø10 × 1 圆片），与台面齐平：给夹底座的磁铁当铁座，夹子啪地吸落在托盘上不再乱动，干的和 v4 那四片粘上去的垫片是同一件事，只是不再用胶。
...
可选件：两段 120 mm 的可调光 5 V USB LED 灯带，贴在侧壁内侧，作为一盏常亮的低亮度定位灯，让你在两次闪光之间看得见画幅。闪光会把它完全压过去，所以不需要每张之间开开关关；一卷拍完再关。
