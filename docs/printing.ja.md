...
STL は 9 ファイルで、**標準ビルドの 8 点＋オプションの 6×6 マスク 1 点**です。うち白が 2 点、黒が 7 点。すべて 1:1 のミリメートル・モデルで、すべてサポートなしで出力でき、フィラメントはセット全体でおよそ **300–350 g、プロトタイプのほぼ 3 分の 1** です。
...
**数量。** セット全体でおよそ **300–350 g**、プロトタイプのほぼ 3 分の 1 です。各色 1 巻きで何度でも作れる量です。
