...
STL は 9 ファイルで、**標準ビルドの 8 点＋オプションの 6×6 マスク 1 点**です。うち白が 2 点、黒が 7 点。すべて 1:1 のミリメートル・モデルで、すべてサポートなしで出力でき、フィラメントはセット全体でおよそ **300–350 g、v4 のほぼ 3 分の 1** です。
...
ほぼ間違いなく出力できます。ビルド最大のパーツである本体と天板ステージは、プレート上で 124.8 × 154.8 mm、最も高いのは 75.6 mm の本体です。**160 × 160 mm のビルドプレートがあればセット全体を出力できます**。つまり現行の小型機まで含めて、ほとんどすべてのデスクトップ機で足ります。v4 時代の大型パーツと筐体外注に関する警告は、v4 とともに廃止されました。
