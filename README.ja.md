...
**画面領域には何も触れない。** フィルムは高さ 0.4 mm の溝に収まり、支持されるのは非画面領域のフィルム縁のみです。画面領域は上下に 0.2 mm 以上浮いているため、擦り傷もニュートンリングも発生しません。コマ送りはフィルムを溝に沿って横方向にスライドさせるだけで、1 本撮り終わるまでホルダーを開ける必要がありません。
