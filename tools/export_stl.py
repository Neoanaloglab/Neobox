#!/usr/bin/env python3
"""Regenerate the twelve published STL files from cad/neobox.blend.
...
MAPPING = {
    ...
    "cover-stage-4x5.stl": ("white-pla", ["cover-stage-4x5"]),
    "sheet-plate-4x5.stl": ("black-pla", ["sheet-plate-4x5"]),
}
